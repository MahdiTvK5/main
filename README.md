...
- پنل مدیریت: مدیریت قیمت‌ها، آفرها، گزارش مالی، پلن‌ها، قیمت اختصاصی کاربر، VIP و نمایندگان، پیام همگانی، ایمپورت کانفیگ
...
```
تست‌های منطق قیمت‌گذاری و لینک به دیتابیس نیاز ندارند. تست‌های یکپارچه‌ی دیتابیس
